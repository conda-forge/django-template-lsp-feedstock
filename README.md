About django-template-lsp-feedstock
===================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/django-template-lsp-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/django-template-lsp-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add django-template-lsp
# for installing globally
pixi global install django-template-lsp
```
...
It is possible to list all of the versions of `django-template-lsp` available on your platform:
...
```
pixi search django-template-lsp --channel conda-forge
```
